...
This is deliberately *not* in [`openloops.tools`](openloops.tools.md#module-openloops.tools). That module is the list every
...
It belongs beside [`openloops.job`](openloops.job.md#module-openloops.job), the other installer, which the CLI also wraps
directly.
